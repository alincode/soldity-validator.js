...
describe('Validators', () => {
  ...
  it('get type range', () => {
    ...
    assert(validator.getRange('int256').MAX === '57896044618658097711785492504343953926634992332820282019728792003956564819967');
    ...
    assert(validator.getRange('uint256').MAX === '115792089237316195423570985008687907853269984665640564039457584007913129639935');
  });
